...
-- RPC: auto_checkin — cria check-in silencioso com cooldown de 4h
-- Retorna true se criou check-in, false se pulou (cooldown)
...
-- Wrapper publico (chamavel via PostgREST)
